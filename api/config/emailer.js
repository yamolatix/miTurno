...
const sendMail = async (user) => {
  ...
  const info = await transporter.sendMail({
    ...
    subject: `Hola ${user.fname[0].toUpperCase()}${user.fname.substring(1)}, bienvenid@ a miTurno`,
...
exports.sendMail = (user) => sendMail(user); //se exporta con el nombre sendMail y que hará referencia a la función sendMail
